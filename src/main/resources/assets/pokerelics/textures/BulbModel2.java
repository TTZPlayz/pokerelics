...
public class BulbOfAbsorptionModel_Converted<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition group = partdefinition.addOrReplaceChild("group", CubeListBuilder.create().texOffs(0, 0).addBox(-5.0F, -5.0F, 0.0F, 10.0F, 10.0F, 3.0F, new CubeDeformation(0.0F))
		.texOffs(0, 13).addBox(-3.0F, -3.0F, 3.0F, 6.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 32.0F, 2.0F));
