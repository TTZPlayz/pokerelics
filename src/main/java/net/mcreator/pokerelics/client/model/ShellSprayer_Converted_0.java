...
public class ShellSprayer_Converted_0<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("pokerelics", "shell_sprayer_converted_0"), "main");
	public final ModelPart group;
	public final ModelPart sprayer;
	public final ModelPart holder;

	public ShellSprayer_Converted_0(ModelPart root) {
