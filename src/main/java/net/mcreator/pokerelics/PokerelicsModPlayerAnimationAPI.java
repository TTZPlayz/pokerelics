...
import net.mcreator.pokerelics.network.LoadPlayerAnimationMessage;
...
public class PokerelicsModPlayerAnimationAPI {
	...
	private static class AnimationLoader {
		...
		public static void loadAnimations(PlayerEvent.PlayerLoggedInEvent event) {
			if (PokerelicsModPlayerAnimationAPI.initialized.get(event.getEntity().getUUID()) == null) {
				if (event.getEntity() instanceof ServerPlayer player) {
					PokerelicsModPlayerAnimationAPI.initialized.put(player.getUUID(), true);
