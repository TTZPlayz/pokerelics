...
import net.mcreator.pokerelics.procedures.MultiquiverRightclickedProcedure;
import net.mcreator.pokerelics.procedures.AutoAttuneProcedureProcedure;

import io.netty.buffer.Unpooled;

public class MultiquiverItem extends Item {
	public MultiquiverItem() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			serverPlayer.openMenu(new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("Multi-Quiver");
				}
		...
		MultiquiverRightclickedProcedure.execute(entity, ar.getObject());
		return ar;
	}
