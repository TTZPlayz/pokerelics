package net.mcreator.pokerelics;
...
import net.mcreator.pokerelics.init.*;
...
@Mod("pokerelics")
public class PokerelicsMod {
	public static final Logger LOGGER = LogManager.getLogger(PokerelicsMod.class);
	public static final String MODID = "pokerelics";

	public PokerelicsMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);

		PokerelicsModBlocks.REGISTRY.register(modEventBus);

		PokerelicsModItems.REGISTRY.register(modEventBus);
		PokerelicsModEntities.REGISTRY.register(modEventBus);
		PokerelicsModTabs.REGISTRY.register(modEventBus);
